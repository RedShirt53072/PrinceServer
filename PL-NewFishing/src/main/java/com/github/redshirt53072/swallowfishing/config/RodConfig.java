package com.github.redshirt53072.swallowfishing.config;
...
import com.github.redshirt53072.swallowfishing.data.RodLootData;


public final class RodConfig {
	public static ArrayList<RodLootData> getAllData() {
		//overworld
		ConfigManager manager = new ConfigManager(SwallowFishing.getInstance(),"rod","rod.yml");
		manager.configInit();
