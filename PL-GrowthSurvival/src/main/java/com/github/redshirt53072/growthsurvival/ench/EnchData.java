...
public class EnchData {
	private Ench type;
	private List<Ench> cantExist;
	private String name;
	private ArrayList<String> lore;
	private int maxLevel;
	private int exp;
	
	public EnchData(Ench type, List<Ench> cantExist,String name,ArrayList<String> lore,int maxLevel,int exp) {
	...
	public static class ScrapData{
		...
		public ScrapData(int amount,Material material) {
			this.amount = amount;
			this.mate = material;
		}
